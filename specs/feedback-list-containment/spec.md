# Feedback List Containment

Contenção vertical da lista de feedbacks na página de lição, garantindo que não ultrapasse uma altura máxima definida e não empurre outros elementos do layout.
