...
Propagação do XP total do usuário do backend para o `AuthContext` do frontend após cada lição concluída, garantindo que o score exibido no menu de navegação reflita o valor mais recente.
